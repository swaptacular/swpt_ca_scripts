...
At this point, the corresponding sub-directory of the "peers" directory (in
this example: `/some-path/peers/fd75076e66e6bd5f8b7dee0e03bd51a0/`) contains
all the necessary information for your servers to accept and initiate
